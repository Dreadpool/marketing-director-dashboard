...
export default function CalendarPage() {
  ...
  // Map workflows to their due dates in the viewed month
  ...
  // Build agenda: group by due date, sorted by day
  const agendaDays = Object.keys(dueDateMap)
    .map(Number)
    .sort((a, b) => a - b);

  // Overdue workflows (current due date is in the past and not satisfied)
